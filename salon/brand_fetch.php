...
foreach($result as $row)
{
	...
	$sub_array[] = $status;
	$sub_array[] = '<button type="button" name="update" id="'.$row["brand_id"].'" class="btn btn-primary btn-xs update">Update</button>';
	$sub_array[] = '<button type="button" name="delete" id="'.$row["brand_id"].'" class="btn btn-success btn-xs delete" data-status="'.$row["brand_status"].'">Change</button>';
	$data[] = $sub_array;
}
