...
foreach($result as $row)
{
	...
	$sub_array[] = '<button type="button" name="update" id="'.$row["product_id"].'" class="btn btn-primary btn-xs update">Update</button>';
	$sub_array[] = '<button type="button" name="delete" id="'.$row["product_id"].'" class="btn btn-success btn-xs delete" data-status="'.$row["product_status"].'">Change Status</button>';
	$data[] = $sub_array;
}
