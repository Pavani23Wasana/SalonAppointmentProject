...
if(isset($_GET["pdf"]) && isset($_GET['order_id']))
{
	...
	foreach($result as $row)
	{
		...
		<table width="100%" border="3" cellpadding="5" cellspacing="0">
			<tr>
				<td colspan="2" align="center" style="font-size:18px"><b>PAYMENT  INVOICE</b></td>
			</tr>
			...
			<table width="100%" cellpadding="2">
				<tr>
					...
					<br />
						<img src="images/logo.png" class="img-fluid" alt="" style="height: 60px; width: 80px; align : center">
					</td>
					<td width="40%">
					<br /><br>
						Salon Manori<br />
						Infront of Peoples Bank<br />
						Ambalantota<br /><br>
						</td>
				</tr>
		...
		$output .= '
						...
						<br />
						<p align="center">_______________________________________________________________<br />If You have any questions about this invoice, Please Contact</p>
						<p align="center">Manori : 0475678945</p>
